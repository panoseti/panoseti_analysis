...
@pytest.mark.parametrize(
    ...
    [
        ...
        "panoseti_analysis.adapters.ml.tracking",
        "panoseti_analysis.adapters.ml.data",
        "panoseti_analysis.adapters.ml.runner",
        "panoseti_analysis.adapters.ml.reporting",
        "panoseti_analysis.algorithms.training",
        "panoseti_analysis.algorithms.cloud_train",
        "panoseti_analysis.algorithms.vae_train",
